...
Through the weak-field metric proof, the candidate inherits dependencies on Postulates 1 and 3, mass-energy equivalence, the redshift proof, the time dilation proof, and special relativity. The candidate does not invoke these directly but they are in the chain.
