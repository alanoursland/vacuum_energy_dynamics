...
T4 establishes temporal self-coupling from the P9+C2 static bootstrap. It gives
...
The second-order temporal response comes from the P9+C2/T4 chain: static exterior temporal self-coupling.
...
The spatial coefficient comes from P7'/T3. The temporal second-order coefficient comes from P9+C2/T4. These are separate structural results with separate roles. They should not be collapsed into a single all-orders scalar exponential ansatz.
...
T5 is a theorem of the current framework. It uses P7' through T3 and P9+C2 through T4.
...
T5 is now downstream of the modern exterior chain: P7' supplies the static frame-indifference shadow used by T3, and P9+C2 supplies the temporal self-coupling theorem used by T4.
