#!/usr/bin/env python3
"""
make_28_status_after_action_selection_gates.py

Generate a status report after proofs 24-27.

Output:
    28_status_after_action_selection_gates.md
"""

from pathlib import Path


md = """# Vacuum Action Origin: Status After Proofs 24-27
...
out = Path(__file__).with_name("28_status_after_action_selection_gates.md")
