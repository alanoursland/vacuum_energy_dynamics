#!/usr/bin/env python3
"""
make_42_interval_to_action_link_status.py

Summarize matter-source-origin gate proofs 37-41.

Output:
    42_interval_to_action_link_status.md
"""
...
md = """# Matter Source Origin Gate: Interval-To-Action Link Status After Proofs 37-41
...
out = base / "42_interval_to_action_link_status.md"
tmp = out.with_suffix(out.suffix + ".tmp")
tmp.write_text(md, encoding="utf-8")
tmp.replace(out)

print("Interval-to-action link status validated.")
