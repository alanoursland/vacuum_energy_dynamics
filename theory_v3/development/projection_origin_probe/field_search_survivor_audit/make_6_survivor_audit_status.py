#!/usr/bin/env python3
"""
make_6_survivor_audit_status.py

Generate status report for the first field_search_survivor_audit batch.

Output:
    6_survivor_audit_status.md
"""
...
if missing:
    raise AssertionError(f"missing survivor audit reports: {missing}")

report_lines = "\n".join("- `" + report + "`" for report in required_reports)

md = f"""# Field Search Survivor Audit: Status After Proofs 1-5
...
out = here / "6_survivor_audit_status.md"
out.write_text(md, encoding="utf-8")

print("All survivor audit references validated.")
