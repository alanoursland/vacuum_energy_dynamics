#!/usr/bin/env python3
"""
make_34_ladder_conclusion_report.py

Generate a concise conclusion report for the regularity_admissibility_ladder
sub-branch.
...
md = """# Regularity-Admissibility Ladder: Conclusion
...
out = Path(__file__).with_name("34_ladder_conclusion_report.md")
