#!/usr/bin/env python3
"""
make_60_bridge_status_after_multipoles.py

Generate a status report after proofs 53-59.

Output:
    60_bridge_status_after_multipoles.md
"""

from pathlib import Path


md = """# Boundary Flux Field Bridge: Status After Proofs 53-59
...
out = Path(__file__).with_name("60_bridge_status_after_multipoles.md")
