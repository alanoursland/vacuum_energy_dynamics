#!/usr/bin/env python3
"""
make_108_eh_origin_status_after_variation_gate.py

Generate a status report after proofs 103-107.

Output:
    108_eh_origin_status_after_variation_gate.md
"""

from pathlib import Path


md = """# Einstein-Hilbert Origin Tests: Status After Proofs 103-107
...
out = Path(__file__).with_name("108_eh_origin_status_after_variation_gate.md")
