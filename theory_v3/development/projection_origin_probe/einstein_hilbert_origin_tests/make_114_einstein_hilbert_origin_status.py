#!/usr/bin/env python3
"""
make_114_einstein_hilbert_origin_status.py

Generate a status report after proofs 109-113.

Output:
    114_einstein_hilbert_origin_status.md
"""

from pathlib import Path


md = """# Einstein-Hilbert Origin Tests: Status After Proofs 109-113
...
out = Path(__file__).with_name("114_einstein_hilbert_origin_status.md")
