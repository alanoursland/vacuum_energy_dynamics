#!/usr/bin/env python3
"""
make_12_status_after_propagation_and_candidate_audit.py

Generate a status report after proofs 7-11.

Output:
    12_status_after_propagation_and_candidate_audit.md
"""

from pathlib import Path


md = """# Vacuum Action Origin: Status After Proofs 7-11
...
out = Path(__file__).with_name("12_status_after_propagation_and_candidate_audit.md")
