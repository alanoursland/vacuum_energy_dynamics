#!/usr/bin/env python3
"""
make_6_vacuum_action_origin_initial_status.py

Generate the initial status report for the vacuum_action_origin proof phase.

Output:
    6_vacuum_action_origin_initial_status.md
"""

from pathlib import Path


md = """# Vacuum Action Origin: Initial Status After Proofs 1-5
...
out = Path(__file__).with_name("6_vacuum_action_origin_initial_status.md")
