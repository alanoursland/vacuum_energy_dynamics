...
| nonzero Lambda baseline | allowed but unvalued | full selector sweep (variational, boundary, topology, measure, relaxation, frustration-floor) derives no value without importing a scale |
