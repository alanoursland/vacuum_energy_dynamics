...
def prepare_archive():
    ...
    dependencies = [
        ...
        (
            "obligation_dep_23",
            "023_smooth_support_and_matching_laws__candidate_matching_law_theorem_obligations",
...
def build_handoffs() -> List[HandoffOption]:
    return [
        HandoffOption(
            ...
            route="024_metric_insertion_recovery_retest",
        ...
        HandoffOption(
            ...
            route="024_role_specific_boundary_projectors",
        ...
        HandoffOption(
            ...
            route="024_source_compatible_boundary_laws",
        ...
        HandoffOption(
            ...
            route="024_reduced_observational_audit",
