...
SCOPE = 'Group 59 transition-term audit problem'
NEXT_SCRIPT = 'candidate_residue_inventory.py'

ENTRIES = [('P1: audit scope', 'transition residues and weighted-neutral layer shapes', 'TRANSITION_AUDIT_OPENED', 'Group 59 may generate candidate surfaces from layer diagnostics', 'not insertion'), ('P2: inherited route', 'Group 58 weighted-neutral route survives conditionally', 'WEIGHTED_LAYER_ROUTE_SURVIVES_CONDITIONALLY', 'weighted-neutral layer is available as test shape', 'not physical use'), ('P3: candidate discipline', 'candidate transition terms must pass locality, neutrality, source/trace, and divergence filters', 'POLICY_RULE', 'survival requires filters, not naming', 'not optional'), ('P4: physical-use block', 'insertion, active O, recombination, and parent closure remain closed', 'NOT_INSERTABLE', 'candidate audit is not field equation', 'not parent-ready')]
SHORTCUTS = [('X1: residue insertion', 'insert blend residues as repair tensors', 'residues are candidate clues only'), ('X2: weighted profile insertion', 'insert the Group 58 profile as B_s/F_zeta term', 'weighted neutrality is not insertion'), ('X3: candidate by name', 'call a term admissible without filters', 'all candidate terms must be tested')]
OBLIGATIONS = [('O1: apply filters', 'POLICY_RULE', 'apply locality, weighted neutrality, source/trace, and divergence filters', 'avoid fake candidate status'), ('O2: keep physical use blocked', 'NOT_INSERTABLE', 'do not open insertion, active O, recombination, or parent closure', 'avoid status inflation')]
LOCAL_CONCLUSIONS = [('transition audit opened', 'PASS', 'Group 59 may proceed to inventory candidate transition surfaces'), ('physical use remains blocked', 'NOT_INSERTABLE', 'no insertion or parent route opened')]
