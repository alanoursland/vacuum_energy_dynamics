...
def prepare_archive():
    ...
    ns.declare_dependency(dependency_id='g61_class', upstream_script_id='61_source_safety_audit__candidate_source_route_classifier', upstream_derivation_id='g61_class')
