...
def main():
    ...
    header("Candidate Group 97 Status Summary")
    print("Group 97 attempts to reduce parity gap structure to exact positive differences.")
    print("Stable result:")
    print("  branch gap differences positive through tested range")
    print("  branch ratio differences positive through tested range")
    print("  interlacing differences positive through tested range")
    ...
    with out.counterexamples():
        out.line("finite evidence as theorem", StatusMark.FAIL, "finite difference tests are not theorem")
        out.line("parent equation", StatusMark.FAIL, "parent construction remains forbidden")
    with out.unresolved_obligations():
        out.line("difference numerator theorem", StatusMark.OBLIGATION, "prove positive difference numerators")
        out.line("parity theorem", StatusMark.OBLIGATION, "prove parity gap monotonicity/interlacing all-order")

    print("\nRecommended next routes:")
    print("  98_difference_numerator_factorization_attempt")
    print("  98_parity_gap_asymptotic_probe")
    print("  98_post_transition_alpha_correction_sign_theorem_attempt")
    print("  98_biorthogonal_pivot_construction")
    print("  98_hankel_difference_pivot_analysis")

    record_marker(ns, MARKER_ID, "Group 97 summary; parity gap theorem attempt")
    record_claim(ns, MARKER_ID, "g97_summary_c1", GovernanceStatus.POLICY_RULE, "Group 97 identifies exact positive rational difference targets for parity gap monotonicity/interlacing.")
    record_claim(ns, MARKER_ID, "g97_summary_c2", GovernanceStatus.POLICY_RULE, "All-order parity gap, ratio-bound, Schur positivity, and determinant nonzero theorems remain open.")
    record_obligation(ns, "g97_summary_o1", "Attempt difference numerator factorization/positivity next.")
    record_obligation(ns, "g97_summary_o2", "Parent divergence identity remains unproven.")
