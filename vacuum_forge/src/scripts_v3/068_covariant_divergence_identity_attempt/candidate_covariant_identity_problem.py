...
SCOPE = 'Group 68 covariant identity problem'
NEXT_SCRIPT = 'candidate_no_repair_identity_target.py'

ENTRIES = [('P1: starting point', 'Group 67 strict incidence and divergence obstruction', 'DIVERGENCE_ATTEMPT_OPENED', 'D_count(strict)=0 but D_parent(strict) remains open', 'not construction'), ('P2: transition status', 'diagnostic-only', 'TRANSITION_REMAINS_DIAGNOSTIC', 'transition response remains unavailable as divergence carrier', 'hard fence'), ('P3: parent status', 'parent equation blocked', 'PARENT_EQUATION_BLOCKED', 'no parent equation should be written here', 'blocked')]
SHORTCUTS = [('X1: write parent equation', 'construct parent field equation during divergence audit', 'identity attempt is not construction'), ('X2: use repair current', 'choose D_repair to cancel remaining divergence', 'repair is not derivation'), ('X3: active O by label', 'assume O supplies missing divergence cancellation', 'O is not constructed')]
OBLIGATIONS = [('O1: identity target', 'DIVERGENCE_IDENTITY_REQUIRED', 'derive no-repair and O-free divergence targets', 'avoid vague conservation language'), ('O2: physical use blocked', 'NOT_INSERTABLE', 'do not open transition insertion, active O, recombination, or parent closure', 'avoid status inflation')]
LOCAL_CONCLUSIONS = [('divergence attempt opened', 'PASS', 'Group 68 may derive no-repair identity targets'), ('parent equation remains blocked', 'PARENT_EQUATION_BLOCKED', 'no parent equation opened')]
