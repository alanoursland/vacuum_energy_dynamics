...
def prepare_archive():
    ...
    dependencies = [
        ...
        (
            "obligation_dep_24",
            "24_metric_insertion_recovery_retest__candidate_metric_insertion_theorem_obligations",
...
def build_handoffs() -> List[HandoffOption]:
    return [
        HandoffOption(
            ...
            route="25_residual_kill_or_no_overlap_theorem",
        ...
        HandoffOption(
            ...
            route="25_role_specific_boundary_projectors",
        ...
        HandoffOption(
            ...
            route="25_source_compatible_boundary_laws",
        ...
        HandoffOption(
            ...
            route="25_reduced_observational_audit",
