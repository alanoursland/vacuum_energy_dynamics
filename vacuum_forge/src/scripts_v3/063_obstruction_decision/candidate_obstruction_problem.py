...
SCOPE = 'Group 63 obstruction decision problem'
NEXT_SCRIPT = 'candidate_obstruction_inputs.py'

ENTRIES = [('P1: decision target', 'source-independent stress-only transition response', 'OBSTRUCTION_DECISION_OPENED', 'status must be decided after Group 62 obstruction', 'not insertion'), ('P2: obstruction state', 'stress accounting not closed', 'STRESS_ACCOUNTING_NOT_CLOSED', 'candidate cannot be promoted by default', 'open'), ('P3: physical-use block', 'insertion, active O, recombination, and parent closure remain closed', 'NOT_INSERTABLE', 'decision audit is not field equation', 'not parent-ready')]
SHORTCUTS = [('X1: promote despite obstruction', 'insert or upgrade the candidate after Group 62', 'stress accounting is not closed'), ('X2: retain without contract', 'keep live candidate without naming required principle', 'candidate hoarding risk'), ('X3: treat downgrade as failure', 'avoid diagnostic-only status because it feels disappointing', 'clean downgrade is progress')]
OBLIGATIONS = [('O1: decision surface', 'POLICY_RULE', 'classify insertion, unqualified retention, conditional retention, and diagnostic-only downgrade', 'avoid ambiguous status'), ('O2: physical use blocked', 'NOT_INSERTABLE', 'do not open insertion, active O, recombination, or parent closure', 'avoid status inflation')]
LOCAL_CONCLUSIONS = [('obstruction decision opened', 'PASS', 'Group 63 may proceed to obstruction input inventory'), ('physical use remains blocked', 'NOT_INSERTABLE', 'no insertion or parent route opened')]
