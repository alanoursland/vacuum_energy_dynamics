...
def prepare_archive():
    ...
    ns.declare_dependency(
        dependency_id="F_zeta_companion_map_inventory_marker",
        upstream_script_id="014_kappa_zeta_map_and_projectors__candidate_F_zeta_companion_map_inventory",
        upstream_derivation_id="F_zeta_companion_map_inventory_marker",
    )
