...
def prepare_archive():
    ...
    dependencies = [
        ...
        (
            "g30_isd",
            "030_minimal_coefficient_sector_postulate_inventory__candidate_incidence_source_divergence_postulate_inventory",
...
def build_handoffs() -> List[FinalHandoff]:
    return [
        FinalHandoff(
            ...
            route="031_source_divergence_coefficient_law",
        ...
        FinalHandoff(
            ...
            route="031_explicit_minimal_postulate_selection",
            status="OPEN",
        ...
        FinalHandoff(
            ...
            route="031_trace_normalization_choice_or_theorem",
            status="OPEN",
        ...
        FinalHandoff(
            ...
            route="031_safe_trace_membership_choice_or_theorem",
            status="OPEN",
        ...
        FinalHandoff(
            ...
            route="031_Bs_Fzeta_insertion_theorem",
            status="NOT_READY",
