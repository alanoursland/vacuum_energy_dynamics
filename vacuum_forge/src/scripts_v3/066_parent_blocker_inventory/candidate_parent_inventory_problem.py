...
SCOPE = 'Group 66 parent inventory problem'
NEXT_SCRIPT = 'candidate_artifact_status_ledger.py'

ENTRIES = [('P1: starting point', 'transition response is diagnostic-only', 'PARENT_INVENTORY_OPENED', 'parent inventory begins after Group 65 quarantine', 'not transition insertion'), ('P2: group target', 'remaining parent blockers', 'PARENT_INVENTORY_OPENED', 'inventory source/trace/divergence/covariance/boundary/O/recombination blockers', 'not construction'), ('P3: parent status', 'parent equation blocked', 'PARENT_EQUATION_BLOCKED', 'no parent equation should be written here', 'blocked')]
SHORTCUTS = [('X1: write parent equation', 'construct parent field equation during inventory', 'inventory is not construction'), ('X2: revive transition response', 'use diagnostic-only object as parent ingredient', 'Group 65 forbids physical use'), ('X3: treat inventory as theorem', 'claim source/divergence/covariance solved by listing them', 'inventory only names blockers')]
OBLIGATIONS = [('O1: artifact ledger', 'POLICY_RULE', 'classify current artifacts by parent usability', 'avoid hidden candidate drift'), ('O2: physical use blocked', 'NOT_INSERTABLE', 'do not open transition insertion, active O, recombination, or parent closure', 'avoid status inflation')]
LOCAL_CONCLUSIONS = [('parent inventory opened', 'PASS', 'Group 66 may inventory remaining parent blockers'), ('parent equation remains blocked', 'PARENT_EQUATION_BLOCKED', 'no parent field equation opened')]
