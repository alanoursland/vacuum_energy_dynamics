...
SCOPE = 'Group 62 stress accounting problem'
NEXT_SCRIPT = 'candidate_closure_inventory.py'

ENTRIES = [('P1: audit target', 'source-independent stress-only transition response', 'STRESS_AUDIT_OPENED', 'Group 62 tests stress-energy accounting for the retained Group 61 audit candidate', 'not insertion'), ('P2: closure danger', 'u must not be chosen by convenience', 'POLICY_RULE', 'trace and mass diagnostics require derived closure', 'not optional'), ('P3: physical-use block', 'insertion, active O, recombination, and parent closure remain closed', 'NOT_INSERTABLE', 'stress audit is not field equation', 'not parent-ready')]
SHORTCUTS = [('X1: choose u to win', 'select energy density only to pass one diagnostic', 'closure must be derived'), ('X2: trace-free implies mass-safe', 'use trace neutrality as active-mass neutrality', 'Group 61 found tension'), ('X3: immediate insertion', 'insert stress response before accounting', 'not licensed')]
OBLIGATIONS = [('O1: stress accounting', 'ENERGY_ACCOUNTING_REQUIRED', 'test closure families, pressure sum, integrated accounting, sign burden, and amplitude origin', 'avoid arbitrary stress tensor'), ('O2: physical use blocked', 'NOT_INSERTABLE', 'do not open insertion, active O, recombination, or parent closure', 'avoid status inflation')]
LOCAL_CONCLUSIONS = [('stress audit opened', 'PASS', 'Group 62 may proceed to closure inventory'), ('physical use remains blocked', 'NOT_INSERTABLE', 'no insertion or parent route opened')]
