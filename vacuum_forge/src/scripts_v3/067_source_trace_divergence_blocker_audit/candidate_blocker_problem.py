...
SCOPE = 'Group 67 blocker problem'
NEXT_SCRIPT = 'candidate_source_trace_incidence_audit.py'

ENTRIES = [('P1: starting point', 'Group 66 parent blockers', 'BLOCKER_AUDIT_OPENED', 'source/trace/divergence is top route after parent blocker inventory', 'not construction'), ('P2: transition status', 'diagnostic-only', 'TRANSITION_REMAINS_DIAGNOSTIC', 'transition response remains unavailable as parent ingredient', 'hard fence'), ('P3: parent status', 'parent equation blocked', 'PARENT_EQUATION_BLOCKED', 'no parent equation should be written here', 'blocked')]
SHORTCUTS = [('X1: write parent equation', 'construct parent field equation during blocker audit', 'audit is not construction'), ('X2: revive transition', 'use diagnostic transition material as source/trace/divergence term', 'Group 65 forbids physical use'), ('X3: count list as proof', 'claim source/trace/divergence solved by naming them', 'must derive incidence and divergence constraints')]
OBLIGATIONS = [('O1: incidence audit', 'POLICY_RULE', 'derive source and trace count-once incidence residuals', 'avoid vague count language'), ('O2: physical use blocked', 'NOT_INSERTABLE', 'do not open transition insertion, active O, recombination, or parent closure', 'avoid status inflation')]
LOCAL_CONCLUSIONS = [('blocker audit opened', 'PASS', 'Group 67 may derive incidence constraints'), ('parent equation remains blocked', 'PARENT_EQUATION_BLOCKED', 'no parent equation opened')]
