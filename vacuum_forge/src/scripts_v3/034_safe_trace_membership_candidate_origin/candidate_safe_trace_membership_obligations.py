...
def prepare_archive():
    ...
    dependencies = [
        (
            ...
            "34_safe_trace_membership_candidate_origin__candidate_safe_trace_membership_compatibility_sieve",
            "g34_safe_membership_compatibility_sieve",
            RecordKind.INVENTORY_MARKER,
        ),
        (
            "g34_candidate_forms",
            "34_safe_trace_membership_candidate_origin__candidate_safe_trace_membership_candidate_forms",
            "g34_safe_membership_candidate_forms",
            RecordKind.INVENTORY_MARKER,
        ),
        (
            "g34_selector_firewall",
            "34_safe_trace_membership_candidate_origin__candidate_safe_trace_membership_selector_rejection",
